...
from api.apps.projects.models import Project, ProjectProfile, ProjectEarning, ProjectExpense
from api.apps.projects.serializers import (ProjectsSerializer, ProjectProfileSerializer, ProjectEarningSerializer, \
...
class BaseTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.project = self.create_project('kla gh 01', 'our first green house', '2020-01-01', '2020-02-02', 90,
                                           '2020-02-03')
